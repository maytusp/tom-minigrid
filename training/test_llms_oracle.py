# Give full trajectory and ask which door is opened first
import os
import glob
...
Initially, all doors are opened (10) and will be closed (9) after STAR is reached. 
P has to open the door and see what is inside the room.
...
### YOUR TASK
Answer which door is opened by P first given a symbolic video of a full episode.

### INPUT FORMAT
A video of symbolic observation of a full episode.
...
file_dir =  "./logs/eval_trajs/tworoom_noswap/"
...
for (file_path, data) in file_list:
    ...
    observations_data = total_observations
    if ego_file_path:
        action_map = {
                0: "go forward",
                1: "turn right",
