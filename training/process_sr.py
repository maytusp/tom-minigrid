...
def main():
    ...
    parser.add_argument("--input_dir", type=str, default="./logs/train_trajs/tworoom_noswap", help="Path to original data")
    parser.add_argument("--output_dir", type=str, default="./logs/train_trajs/tworoom_noswap_with_sr", help="Path to save processed data")
